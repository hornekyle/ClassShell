...
add_custom_target("Objectives" ALL)
...
foreach(MODULE ${MODULES_LIST})
	...
	set(TARGET_NAME "Include-+-${MODULE}-+-Objectives")
	
	set(TEX_FILE "Includes/${MODULE}/Objectives.tex")
	...
	add_custom_command(
		...
		COMMAND
			...
			"--objectives" "${MODULE}" "${TEX_FILE_FULL}"
		MAIN_DEPENDENCY
	...
	add_dependencies("Objectives" "${TARGET_NAME}")
